<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']))
	{
		...
		$query_config   = mysqli_query($connection,"SELECT * FROM configuracion");
	...
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="http://localhost/facturacion/sistema/factura/img/logo.jpg" width="100px" height="100px">
				</div>
			</td>
			 ...
			 ?>
				<tr>
					...
					<?php
						...
						if($row["codmedida"] == 2){
							$precio_total =($row["cantidad"] * $row["precio_venta"])/1000;
						}else{
							$precio_total =($row["cantidad"] * $row["precio_venta"]);
						}
					?>

					<td class="textright"><?php echo $precio_total; ?></td>
				</tr>
			<?php
