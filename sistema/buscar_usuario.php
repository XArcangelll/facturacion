    ...
    ?>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a class="link_edit" href="editar_usuario.php?id=<?php echo $result["idusuario"]?>">Editar</a>
                    

                    <?php
                        if($result["idrol"] != 1){
                    ?>
                    <a class="link_delete" href="eliminar_confirmar_usuario.php?id=<?php echo $result["idusuario"]?>">Eliminar</a>
        ...
        <div class="paginador">
                                <ul>
                                    ...
                                    <li><a href="?pagina=<?php echo ($pagina == 1) ? 1 : $pagina-1?>&busqueda=<?php echo $busqueda?> "><<<</a></li>
                                ...
                                if($pagina != $total_paginas) { ?>
                                    <li><a href="?pagina=<?php echo ($pagina >= $total_paginas ) ? $total_paginas : $pagina+1?>&busqueda=<?php echo $busqueda?>">>>></a></li>
